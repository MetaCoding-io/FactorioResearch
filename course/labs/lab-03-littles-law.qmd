...
3. Click the inserter, then walk east and click the **last belt tile
   before the first machine's input inserter**. Press **Q** to put the
   wire away.
...
<!-- TODO(screenshots): drop PNGs into course/images/lab-03/ and uncomment.
![The debrief: `fisl compare` of the push baseline vs the pull run.](../images/lab-03/compare-terminal.png){#fig-compare}
-->

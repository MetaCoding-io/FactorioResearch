...
- Baseline reference numbers come from run `01M0XP8VJ78KXRC8DB6BATBW39`
  (committed verification summary matches). Measured pull-solution result
  (run `01M0Y3SH364FWVZR8NBSDC2WYZ`, solution v3): TH unchanged at
  15.00/min, avg WIP 19.16 (−62.9%), CT 76.64 s — right on the transit
  floor predicted in the solution README.

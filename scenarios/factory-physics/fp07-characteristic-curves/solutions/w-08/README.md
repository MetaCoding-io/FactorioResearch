# fp07 solution w-08 — CONWIP cap at W < 8

One gate, four cap levels (w-04/w-08/w-14/w-24): the sweep that traces
the line's characteristic curves. This point sits below the knee.

**First-order prediction:** TH ~ 8.6/min at CT ~ 56 s: throughput still buys linearly with WIP. The measured point lands at or below
...
**Measured** (reference dataset): avg WIP 8.03, TH 10.90/min, CT 44.20 s — still on the rising branch, ~2.5% under the bound (belt discreteness near the knee).
